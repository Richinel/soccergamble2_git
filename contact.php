		...
		<div class="wrapper">
			...
			<div class="row contact_row">
				...
				<div class="col">
					<fieldset>
						<legend>Kaart</legend>
						<iframe width="100%" height="300" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?q=place_id:Ei5TdG9sd2lqa3N0cmFhdCA4LCAzMDc5IEROIFJvdHRlcmRhbSwgTmVkZXJsYW5k&key=AIzaSyCgEtR9sabAay2aLccBt4c5WeWCoEHFpbk" allowfullscreen></iframe>
					</fieldset>
				</div>
			</div>

			<fieldset>
				<legend>Contactopties</legend>
